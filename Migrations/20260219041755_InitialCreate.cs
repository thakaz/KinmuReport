        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    操作日時 = table.Column<DateTime>(type: "TEXT", nullable: false),
                    操作種別 = table.Column<string>(type: "TEXT", nullable: false),
                    テーブル名 = table.Column<string>(type: "TEXT", nullable: false),
                    レコードキー = table.Column<string>(type: "TEXT", nullable: true),
                    操作者 = table.Column<string>(type: "TEXT", nullable: true),
                    変更内容 = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_監査ログ", x => x.Id);
                });
